#pragma checksum "D:\C#\_Asyst-lab\ImageManager\ImageManager.MVC\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "f5bfb62944c3ecf54edeb2bc765604584a59e583"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"f5bfb62944c3ecf54edeb2bc765604584a59e583", @"/Views/Home/Index.cshtml")]
...
<div class=""col-sm-12"">
    ...
    <div class=""row work-div"">
        <div id=""imageActionDiv"" class=""pl-sm-4 pr-sm-4 border rounded tool-div"" title=""Сначала откройте изображение."">
            <b>Модераторы</b><br />
            <button id=""cutAct");
            WriteLiteral(@"ion"" class=""btn btn-filter"" disabled>обрезать</button><br />
            ...
            <button id=""notBrightnessFilter"" class=""btn btn-filter"" disabled onclick=""notBrightnessFiltrButton_click()"">темное</button><br />

            <button id=""contrastFilter"" class=""btn btn-filter"" disabled onclick=""c");
            WriteLiteral(@"ontrastFiltrButton_click()"">контрастное</button><br />
            ...
            <button id=""noneF");
            WriteLiteral("ilter\" class=\"btn btn-filter\" disabled onclick=\"noneFiltrButton_click()\">нет</button><br />\r\n        </div>\r\n\r\n        <div class=\"bg-secondary canvas-div\">\r\n            <canvas id=\"myCanvas\"");
